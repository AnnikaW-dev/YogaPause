# **_Yoga Pause - Project Portfolio 1 - HTML & CSS_**
Yoga Pause is for all that site still for long times infront of a computer as a remider to take a pause and do some smoth movement. As a user you can choice from Chair Yoga, Standing Yoga, Meditation or a fun Challenge. All this to take a short pause from the work and get to breath and enjoy some minutes of peace of mind. 

You can view the live site here - <a href="#" target="_blank"> Yoga Pause </a>

![Yoga Pause responsive design](assets/images/readme-images/responsive-website-view.png)
